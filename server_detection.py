"""
Uses a CNN to detect fires which have been filtered by the rule-based onboard algorithm as possibly containing fires.
This part of the hybrid algorithm minimises false positives using an architecture similar to the inception one,which is
